...
eps = 0.1
train_label_one_hot = train_label_one_hot * (1 - eps) + eps / num_classes
...
model = MLP(784, 10)
model.train(train_data, train_label_one_hot, epoch=200, lr=0.1)
model.plot_loss('LabelSmoothing.png', model.test(test_data, test_label_one_hot))
