...
class MLP:
    def __init__(self, input_size, output_size):
        ...
        self.W1 = np.random.normal(loc=0.0, scale=np.sqrt(2.0 / input_size), size=(input_size, 256))
        self.W2 = np.random.normal(loc=0.0, scale=np.sqrt(2.0 / 256.0), size=(256, output_size))
...
model.plot_loss('he_init.png', model.test(test_data, test_label_one_hot))
